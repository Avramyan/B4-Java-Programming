...
public class LongestWithA {
    public static void main(String[] args) {
        ...
        // T: Improve the code - implement the option if the words to no have "a" in it. But if there word with "a" then print that one.
        //  HINT: nested if
        ...
        } else if (!(word1.contains("a") && word2.contains("a") && word3.contains("a"))) {
            System.out.println("NO any WORDS that contain \"a\"");
