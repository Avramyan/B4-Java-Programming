...
public class Login {
    public static void main(String[] args) {
        ...
        if (isValid) {
            ...
            boolean ifPassword8char = inputPassword.length() == 8;
            boolean ifPasswordCorrect = inputPassword.equals(expectedPassword);
            boolean ifUsernameCorrect = inputUsername.equals(expectedUsername);
